...
static const _CmdMsg_type_support_symbol_names_t _CmdMsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_msg, msg, CmdMsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, car_msg, msg, CmdMsg)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, car_msg, msg, CmdMsg)() {
  return &::car_msg::msg::rosidl_typesupport_c::CmdMsg_message_type_support_handle;
}
