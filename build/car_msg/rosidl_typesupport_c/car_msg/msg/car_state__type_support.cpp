...
#include "car_msg/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _CarState_type_support_symbol_names_t _CarState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, car_msg, msg, CarState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, car_msg, msg, CarState)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_car_msg
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, car_msg, msg, CarState)() {
  return &::car_msg::msg::rosidl_typesupport_c::CarState_message_type_support_handle;
}
