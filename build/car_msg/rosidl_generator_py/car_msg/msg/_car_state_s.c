...
bool car_msg__msg__car_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("car_msg.msg._car_state.CarState", full_classname_dest, 31) == 0);
  }
  car_msg__msg__CarState * ros_message = _ros_message;
  {  // x
...
PyObject * car_msg__msg__car_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("car_msg.msg._car_state");
