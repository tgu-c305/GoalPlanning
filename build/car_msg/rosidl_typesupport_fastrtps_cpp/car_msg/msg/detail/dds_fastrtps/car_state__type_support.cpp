...
#include "car_msg/msg/detail/car_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const car_msg::msg::CarState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<car_msg::msg::CarState *>(
    untyped_ros_message);
...
{
  return &car_msg::msg::typesupport_fastrtps_cpp::_CarState__handle;
}
