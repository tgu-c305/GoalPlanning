...
#include "imu_msgs/msg/detail/ag051__rosidl_typesupport_fastrtps_c.h"
...
using _AG051__ros_msg_type = imu_msgs__msg__AG051;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _AG051__ros_msg_type * ros_message = static_cast<const _AG051__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _AG051__ros_msg_type * ros_message = static_cast<_AG051__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_imu_msgs__msg__AG051(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AG051__ros_msg_type * ros_message = static_cast<const _AG051__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _AG051__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_imu_msgs__msg__AG051(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_imu_msgs
size_t max_serialized_size_imu_msgs__msg__AG051(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_imu_msgs__msg__AG051(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_AG051 = {
  "imu_msgs::msg",
  "AG051",
...
static rosidl_message_type_support_t _AG051__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, imu_msgs, msg, AG051)() {
  return &_AG051__type_support;
}
