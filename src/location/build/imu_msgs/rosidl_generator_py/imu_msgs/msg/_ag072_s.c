...
bool imu_msgs__msg__ag072__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_msgs.msg._ag072.AG072", full_classname_dest, 25) == 0);
  }
  imu_msgs__msg__AG072 * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of AG072 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_msgs.msg._ag072");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AG072");
